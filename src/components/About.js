...
export default function About(){
    return(
        <><h1 id="p1">React Router Application</h1><div id="App">
            ...
            <div id="part3">
                ...
                <p>There should be two buttons in the footer section, <strong>back and next.</strong>
                    <br />By clicking on back button, previously visited component should be rendered. 
                    <br/>Next button will be used to go back to the current component.</p>
